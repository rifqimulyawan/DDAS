                  ...
                  <div class="container">
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table text-center" height="50%">
                        ...
                        <tr>
                          <td>Nama Lengkap</td><td> : </td><td><?php echo $nama; ?></td>
                        </tr>
                        <tr>
                          <td>Email</td><td> : </td><td><?php echo $email; ?></td>
                        </tr>
                        <tr>
                          <td>Program Studi</td><td> : </td><td><?php echo $nama_prodi; ?></td>
                        </tr>
                        <tr>
                          <td>Profiles Photo</td><td> : </td><td><a data-toggle="modal" data-target="#img-display"><img class="img-thumbnail" width="100" height="100" src="<?php echo base_url() . 'uploads/'.$foto_profil  ?>"/></a></td>
                        </tr>
                      </table>
                      ...
                      <div class="form-group col-sm-12">
                        <center>
                          <a class=" btn btn-secondary col-md-3" href="<?php echo base_url('user') ?>">Kembali</a>&nbsp;
                          <a class=" btn btn-primary col-md-3" href="<?php echo base_url('user/edit_profile') ?>">Perbarui Data ?</a>
                        </center>
                      </div>
